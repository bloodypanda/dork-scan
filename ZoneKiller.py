...
my_cook = {
	"ZHE" : "6d8bb08fd96fd8e0e49974d97f5a0946",
	"PHPSESSID" : "o1kfjnmtfbog0s1ujmph5ofa70"
	}
...
def helper4():
    ...
    ╚══════╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚═════╝ ╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝
                	...
                	Greetz To : \033[93m Bangladeshi \033[92mHackers  \033[91m|D\033[92mz| \033[91mMuslims \033[92mHackers
                                     """)
	slowprint("\n\t\t\t\t\tPowered By :Sys.Admin " + "\n\t\t\t\t\t\t Telegram : @sysadminbd  " + "\n\t\t\t\t\t\t     Facebook:https://www.facebook.com/rafsan.rabin.1337")
	print("")
	print("""
		\033[91m[1] \033[95mGrabb Sites  \033[92m From Zone-h.org   |   
		\033[91m[2] \033[95mGet Sites bypass With List [Bypass Finder]
		\033[91m[3] \033[95mMass Add (http://) To List ^_^
		\033[91m[3] \033[95mGrabber Sites From Bing :D
		\033[91m[4] \033[95mCms Filtre
		\033[91m[5] \033[95mEmail Valid Spotify


			#######################################################
			# 	  We Dont Forgive,We Dont Forget Expect Us     #
			#######################################################
			""")		
	try:
		qq = int(raw_input("\033[91m[-] \033[90msysadmin~# \033[92mChoose Section !!\033[95m : \033[90m"))
		if qq == 1:
			clearscrn()
			print(banner)
			zonehh()
